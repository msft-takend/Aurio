...
namespace Aurio.PFFFT
{
    internal unsafe class Interop64
    {
        ...
        [DllImport(PFFFTLIB, CallingConvention = CC)]
        public static extern void pffft_transform(
            IntPtr setup,
            float* input,
            float* output,
            float* work,
        ...
        [DllImport(PFFFTLIB, CallingConvention = CC)]
        public static extern void pffft_transform_ordered(
            IntPtr setup,
            float* input,
            float* output,
            float* work,
        ...
        [DllImport(PFFFTLIB, CallingConvention = CC)]
        public static extern void pffft_zreorder(
            IntPtr setup,
            float* input,
            float* output,
            Direction direction
        ...
        [DllImport(PFFFTLIB, CallingConvention = CC)]
        public static extern void pffft_zconvolve_accumulate(
            IntPtr setup,
            float* dft_a,
            float* dft_b,
            float* dft_ab,
